...
class Tile:
    ...
    def make_labels(self):
        ...
        self.label_1 = pyglet.text.Label('X', font_name='Times New Roman',
                font_size=20, x=self.x+10, y=self.y+70, batch=self.fgbatch)
        self.label_2 = pyglet.text.Label('X', font_name='Times New Roman',
                font_size=20, x=self.x+70, y=self.y+70, batch=self.fgbatch)
        self.label_3 = pyglet.text.Label(f'{self.idx}',
                font_name='Times New Roman', font_size=24, x=self.x+35,
                y=self.y+25, batch=self.fgbatch)
...
class Game:
    ...
    def make_tiles(self):
        ...
        for idx in range(self.rows * self.columns):
            self.tiles.append(Tile(idx, x, y, 100, 100, (255, 255, 255),
